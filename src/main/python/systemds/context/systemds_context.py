...
class SystemDSContext(object):
    ...
    def __build_startup_command(self, port: int):
        ...
        # Base command
        # Note: locale flags added to avoid Turkish locale issues with case conversion
        command = ["java", "-Duser.language=en", "-Duser.country=US", "--add-modules=jdk.incubator.vector", "-cp"]
